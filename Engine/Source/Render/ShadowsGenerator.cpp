...
namespace psm
{
    ...
    void ShadowsGenerator::Init(DevicePtr device, uint32_t swapchainImages)
    {
    ...
    void ShadowsGenerator::InitDirectionalLightData(uint32_t swapchainImages)
    {
    ...
    ShadowsParams& ShadowsGenerator::GetShadowParams()
    {
