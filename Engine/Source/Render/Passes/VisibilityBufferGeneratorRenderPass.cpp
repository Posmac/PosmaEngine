...
namespace psm
{
    namespace graph
    {
        ...
        void VisibilityBufferGeneratorRenderPassNode::PreRender(CommandBufferPtr& commandBuffer, uint32_t index)
        {
        ...
        void VisibilityBufferGeneratorRenderPassNode::PostRender(CommandBufferPtr& commandBuffer)
        {
